...
#' 
#' @description
#' The function [z2gh()] (not compute intensive) transforms standard normal quantiles \eqn{z_q} to Tukey \eqn{g}-&-\eqn{h} quantiles.
#' 
#' The function [gh2z()] (compute intensive!!) transforms Tukey \eqn{g}-&-\eqn{h} quantiles to standard normal quantiles \eqn{z_q}.
#'  
...
#' 
#' @details
#' Domain of standard normal \link[stats]{quantile} \eqn{z} to search for the function [gh2z()] is hard coded as 
